  ...
  const content = {
    ...
    admin: {
      ...
      flows: [
        ...
        { id: 'analytics', label: '6. LOGS DASHBOARD', screens: [{ title: 'Logs Dashboard', img: '/campuseats/admin/logs/general.jpeg' }, { title: 'Log Filtering', img: '/campuseats/admin/logs/filter.jpeg' }, { title: 'Density Logs', img: '/campuseats/admin/logs/densitylog.jpeg' }] }
      ]
    }
  };
